...
import { Album, TopTracks } from "@/lib/type/spotifyapi";
...
const getSavedAlbums = async (req: any, res: NextApiResponse<TopTracks>) => {
...
export default withSession(getSavedAlbums);
